...
<head>
    ...
    <style>
        ...
        /* Aplicar la animación al texto 403 */
        .floating-text {
...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-white flex items-center justify-center h-screen overflow-hidden">
    ...
    <div class="text-center relative z-10">
        <!-- Número 403 en 3D con efecto flotante -->
        <h1 class="text-8xl font-extrabold relative inline-block">
            <span class="text-transparent bg-clip-text bg-gradient-to-r from-teal-500 to-teal-600 floating-text">403</span>
            <span class="absolute top-2 left-2 text-gray-400 dark:text-gray-700 opacity-40 floating-text">403</span>
        </h1>

        <!-- Mensaje de error -->
        <p class="text-2xl mt-4 font-semibold">¡Acceso denegado!</p>
